        ...
        <>
            <Element name="home" className="element">
                ...
                <section className='relative   '>
                        ...
                        <main className='relative lg:translate-y-0 translate-y-24   md:flex md:justify-center lg:flex grid   lg:justify-around  items-center  z-40'>
                            <div className='ps-9 relative ' >
                                <div className='md:w-[400px] font-semibold lg:w-[500px] text-white font-mono'>
                                    ...
                                    <h2 className=' md:text-5xl sm:text-5xl text-2xl lg:text-5xl'>Hi,I'm <code className=' text-[#ad8e6d]'>Alberto Kyros</code></h2>
                    ...
                    <div className={`absolute bottom-14 ${Scroll > 5 ? 'hidden' : 'visible'} animate-bounce md:left-[28rem] lg:left-[48rem] cursor-pointer left-44 z-50`} onClick={() => { window.scrollTo({ top: 1200, left: 0, behavior: 'smooth' }) }}>
